...
const scripts = require('bull/lib/scripts');
const errors = require('bull/lib/errors');
const utils = require('bull/lib/utils');
...
const commands = require('bull/lib/commands');
...
//
require('bull/lib/getters')(Queue);
require('bull/lib/worker')(Queue);
require('bull/lib/repeatable')(Queue);
...
Queue.prototype.setHandler = function(name, handler) {
  ...
  if (typeof handler === 'string') {
    ...
    const sandbox = require('bull/lib/process/sandbox');
